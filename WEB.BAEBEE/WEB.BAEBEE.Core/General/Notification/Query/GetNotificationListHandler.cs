...
namespace WEB.BAEBEE.Core.Notification.Query
{
    ...
    internal class GetNotificationListHandler : IRequestHandler<GetNotificationListRequest, ListResponse<NotificationResponse>>
    {
        ...
        public async Task<ListResponse<NotificationResponse>> Handle(GetNotificationListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<WEB.BAEBEE.Data.Model.Notification>().AsQueryable();

				#region Filter
				Expression<Func<WEB.BAEBEE.Data.Model.Notification, object>> column_sort = null;
				List<Expression<Func<WEB.BAEBEE.Data.Model.Notification, bool>>> where = new List<Expression<Func<WEB.BAEBEE.Data.Model.Notification, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<WEB.BAEBEE.Data.Model.Notification, bool>> where, Expression<Func<WEB.BAEBEE.Data.Model.Notification, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<WEB.BAEBEE.Data.Model.Notification, object>> result_order = null;
			Expression<Func<WEB.BAEBEE.Data.Model.Notification, bool>> result_where = null;
