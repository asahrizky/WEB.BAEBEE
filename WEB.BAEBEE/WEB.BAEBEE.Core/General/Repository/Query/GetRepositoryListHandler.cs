...
namespace WEB.BAEBEE.Core.Repository.Query
{
    ...
    internal class GetRepositoryListHandler : IRequestHandler<GetRepositoryListRequest, ListResponse<RepositoryResponse>>
    {
        ...
        public async Task<ListResponse<RepositoryResponse>> Handle(GetRepositoryListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<WEB.BAEBEE.Data.Model.Repository>().AsQueryable();

				#region Filter
				Expression<Func<WEB.BAEBEE.Data.Model.Repository, object>> column_sort = null;
				List<Expression<Func<WEB.BAEBEE.Data.Model.Repository, bool>>> where = new List<Expression<Func<WEB.BAEBEE.Data.Model.Repository, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<WEB.BAEBEE.Data.Model.Repository, bool>> where, Expression<Func<WEB.BAEBEE.Data.Model.Repository, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<WEB.BAEBEE.Data.Model.Repository, object>> result_order = null;
			Expression<Func<WEB.BAEBEE.Data.Model.Repository, bool>> result_where = null;
