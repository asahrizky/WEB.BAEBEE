...
namespace WEB.BAEBEE.Core.User.Query
{
    ...
    internal class GetUserListHandler : IRequestHandler<GetUserListRequest, ListResponse<UserResponse>>
    {
        ...
        public async Task<ListResponse<UserResponse>> Handle(GetUserListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<WEB.BAEBEE.Data.Model.User>().AsQueryable();

				#region Filter
				Expression<Func<WEB.BAEBEE.Data.Model.User, object>> column_sort = null;
				List<Expression<Func<WEB.BAEBEE.Data.Model.User, bool>>> where = new List<Expression<Func<WEB.BAEBEE.Data.Model.User, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<WEB.BAEBEE.Data.Model.User, bool>> where, Expression<Func<WEB.BAEBEE.Data.Model.User, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<WEB.BAEBEE.Data.Model.User, object>> result_order = null;
			Expression<Func<WEB.BAEBEE.Data.Model.User, bool>> result_where = null;
