...
namespace WEB.BAEBEE.Core.UserRole.Command
{
    ...
    public class AddUserRoleRequest :UserRoleRequest, IMapRequest<WEB.BAEBEE.Data.Model.UserRole, AddUserRoleRequest>,IRequest<StatusResponse>
    {
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<AddUserRoleRequest, WEB.BAEBEE.Data.Model.UserRole> map)
        {
    ...
    internal class AddUserRoleHandler : IRequestHandler<AddUserRoleRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddUserRoleRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<WEB.BAEBEE.Data.Model.UserRole>(request);
