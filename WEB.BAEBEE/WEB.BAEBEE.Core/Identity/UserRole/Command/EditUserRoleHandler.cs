...
namespace WEB.BAEBEE.Core.UserRole.Command
{
    ...
    public class EditUserRoleRequest :UserRoleRequest, IMapRequest<WEB.BAEBEE.Data.Model.UserRole, EditUserRoleRequest>,IRequest<StatusResponse>
    {
        [Required]
        public Guid Id { get; set; }
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<EditUserRoleRequest, WEB.BAEBEE.Data.Model.UserRole> map)
        {
    ...
    internal class EditUserRoleHandler : IRequestHandler<EditUserRoleRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(EditUserRoleRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var existingItems = await _context.Entity<WEB.BAEBEE.Data.Model.UserRole>().Where(d => d.Id == request.Id).FirstOrDefaultAsync();
