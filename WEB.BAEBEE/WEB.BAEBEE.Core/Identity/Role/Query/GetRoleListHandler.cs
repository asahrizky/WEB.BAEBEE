...
namespace WEB.BAEBEE.Core.Role.Query
{
    ...
    internal class GetRoleListHandler : IRequestHandler<GetRoleListRequest, ListResponse<RoleResponse>>
    {
        ...
        public async Task<ListResponse<RoleResponse>> Handle(GetRoleListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<WEB.BAEBEE.Data.Model.Role>().AsQueryable();

				#region Filter
				Expression<Func<WEB.BAEBEE.Data.Model.Role, object>> column_sort = null;
				List<Expression<Func<WEB.BAEBEE.Data.Model.Role, bool>>> where = new List<Expression<Func<WEB.BAEBEE.Data.Model.Role, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<WEB.BAEBEE.Data.Model.Role, bool>> where, Expression<Func<WEB.BAEBEE.Data.Model.Role, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<WEB.BAEBEE.Data.Model.Role, object>> result_order = null;
			Expression<Func<WEB.BAEBEE.Data.Model.Role, bool>> result_where = null;
