...
using WEB.BAEBEE.Core;
using WEB.BAEBEE.Data;
using WEB.BAEBEE.Shared;
using WEB.BAEBEE.API.Handler;
using Hangfire;
using Hangfire.SqlServer;
using HangfireBasicAuthenticationFilter;
using Microsoft.AspNetCore.Mvc;
using WEB.BAEBEE.Infrastructure.Mail;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJwtBearer(x =>
           {
            ...
            if (_environment.IsDevelopment())
            {
                ...
                {
                    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WEB.BAEBEE.API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.DocumentTitle = "WEB.BAEBEE.API";
